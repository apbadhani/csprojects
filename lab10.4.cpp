...
int main()
{
	...
	Point p1;
	cout<< "x coordinate for p1 is " << p1.Get_X() << endl;
	cout<< "y coordinate for p1 is " << p1.Get_Y() << endl;

	// Declaring a point with coordinates X = 2, Y = 3:
	Point p2(2, 3);
	cout<< "x coordinate for p2 is " << p2.Get_X() << endl;
	cout<< "y coordinate for p2 is " << p2.Get_Y() << endl;
